...
- 
Black-box nature of LLMs means there’s some magic to
LLM-whispering effectively
- 
...
no support
- 
no examples themodernsoftware.dev
...
IndexError: list index out of range
Prompt 5x
Take majority result themodernsoftware.dev
...
IndexError can you ensure that the CI tests still pass?
...
observe reflect
Extend prompt themodernsoftware.dev
