...
## Do I need prior experience with AI tools like Claude Code?
...
Students need access to a computer capable of running modern development tools. Some cloud-based services may require subscriptions (Claude Code, etc.), but the course will provide access or alternatives where possible. A reliable internet connection is essential for cloud-based tools.
